...
\begin{enumerate}[(a)]
	\item \PM At \DTMdisplay{2020}{4}{7}{-1}{13}{23}{00}{+0}{00} something
		something you should be aware. (Would very much like to figure out
		how to use a short date format here without setting the style for
		the entire document).
\end{enumerate}
